            ...
            <Nav className="mr-auto" navbar>
              <InputGroup className="search-bar">
                <Button color="link" onClick={toggleModalSearch}>
                  ...
                  <span className="d-lg-none d-md-block">Procurar</span>
                </Button>
              </InputGroup>
              <UncontrolledDropdown nav>
                ...
                <DropdownMenu className="dropdown-navbar" tag="ul" right>
                  <NavLink tag="li">
                    ...
                    Pedro Bazzo respondeu ao seu email
                    </DropdownItem>
                  </NavLink>
                  <NavLink tag="li">
                    <DropdownItem className="nav-item">
                      Você tem mais 5 tarefas
                    </DropdownItem>
                  </NavLink>
                  <NavLink tag="li">
                    <DropdownItem className="nav-item">
                    Seu amigo(a) está na cidade
                    </DropdownItem>
                  </NavLink>
                  <NavLink tag="li">
                    <DropdownItem className="nav-item">
              ...
              <UncontrolledDropdown nav>
                ...
                >
                  <div className="photo">
                    <img
                      alt="..."
                      src={require("assets/img/anime3.jpeg").default}
                    />
                  </div>
